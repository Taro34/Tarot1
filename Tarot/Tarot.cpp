...
// Tarot.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CTarotApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CTarotApp
...
// Seul et unique objet CTarotApp

CTarotApp theApp;


// initialisation de CTarotApp

BOOL CTarotApp::InitInstance()
{
